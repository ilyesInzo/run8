({	
    ...
    init : function(component, event, helper) {
        ...
        console.log("LC01_Review_US_TubeLaminate.ctrl:Init ");
        ...
        action.setCallback(this, function(response){
            ...
            if (component.isValid() && state === "SUCCESS") {
               ...
               for (var key in priceReviewMaps.PriceDetailMap) {
  				   console.log('--- List Price ---'+priceReviewMaps.PriceDetailMap[key].List_Price__c);
    ...
    updatePriceDetails : function(component, event, helper) {
		...
		console.log("LC01_Review_US_TubeLaminate.ctrl:  Update Price Details ");
        var reviewDetailsMap = component.get("v.PM_ReviewPriceDetails_Map");
