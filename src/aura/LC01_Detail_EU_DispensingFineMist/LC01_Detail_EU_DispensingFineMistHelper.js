({
	...
	getPrices : function(cmp, event){
        ...
        action.setCallback(this, function(response) {
            ...
            console.log(_response.details);
        	this.setPrices(cmp, "v.productDef", 'Product Definition', _response.details);
        	this.setPrices(cmp, "v.pumpDeco", 'Pump Decoration', _response.details);
            this.setPrices(cmp, "v.bottleDeco", 'Bottle Decoration Options', _response.details);
            
        	this.setPrices(cmp, "v.pumpOpt", 'Pump Options', _response.details);
        	this.setPrices(cmp, "v.diptubeOpt", 'Diptube Options', _response.details);
            ...
            cmp.set("v.currency", _response.currency);  
 			...
 			this.descprice(cmp, "v.pumpDeco", "v.pump_Decoration_desc_price");
            this.descprice(cmp, "v.bottleDeco", "v.bottle_Decoration_desc_price");
            
 			this.descprice(cmp, "v.pumpOpt", "v.pump_Options_desc_price");    
 			this.descprice(cmp, "v.diptubeOpt", "v.diptube_Options_desc_price");     			
