({
    init: function(cmp, event, helper) {
        if(cmp.get("v.qli").Id && event.getParam("value").Id && !event.getParam("oldValue").Id){
            ...
            helper.convertList(cmp, "v.pumpDeco");
            helper.convertList(cmp, "v.bottleDeco");
    ...
    pumpDecorationdescprice :  function(cmp, event, helper) {
        console.log('Pump Decoration override click');
        cmp.set("v.pump_Decoration_desc_price","");
        
    },
    
    bottleDecorationdescprice :  function(cmp, event, helper) {
        console.log('Bottle Decoration override click');
        cmp.set("v.bottle_Decoration_desc_price","");
    ...
    savedescprice :  function(cmp, event, helper) {
        ...
        if(cmp.get("v.qli").Id){
            ...
            updatelistitems = helper.savepricehelper(cmp, "Pump Decoration", cmp.get("v.pumpDeco"), updatelistitems);
            updatelistitems = helper.savepricehelper(cmp, "Bottle Decoration", cmp.get("v.bottleDeco"), updatelistitems); 
