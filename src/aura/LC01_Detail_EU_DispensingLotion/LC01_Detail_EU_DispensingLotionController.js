({
    init: function(cmp, event, helper) {
        ...
        helper.convertList(cmp, "v.bottledecoOpt");
    ...
    UpperPartDecoUpchargedescprice :  function(cmp, event, helper) {
    	cmp.set("v.Upper_Part_Deco_Upcharge_desc_price","");
    ...
    BottleDecorationOptionsdescprice :  function(cmp, event, helper) {
    	cmp.set("v.Bottle_Decoration_Options_desc_price","");
    ...
    savedescprice :  function(cmp, event, helper) {
    	...
    	updatelistitems = helper.savepricehelper(cmp, "Upper Part Decoration Upcharge", cmp.get("v.decoUpcharge"), updatelistitems); 
    	updatelistitems = helper.savepricehelper(cmp, "Pump Options", cmp.get("v.pumpOpt"), updatelistitems);  
    	updatelistitems = helper.savepricehelper(cmp, "Bottle Decoration Options", cmp.get("v.bottledecoOpt"), updatelistitems);     	
