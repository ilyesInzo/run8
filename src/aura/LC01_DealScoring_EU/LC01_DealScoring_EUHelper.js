({
    ...
    validatescore: function(cmp, evt, mapopts) {
		...
		(mapopts["disabledfields"].indexOf("DS_Contract_duration__c") != -1 || (qli.DS_Contract_duration__c)) && 
		...
		(mapopts["disabledfields"].indexOf("DS_Albea_dependency_to_suppliers__c") != -1 || (qli.DS_Albea_dependency_to_suppliers__c)) && 
		...
		(mapopts["disabledfields"].indexOf("DS_Skonto_for_cash_payment__c") != -1 || (qli.DS_Skonto_for_cash_payment__c))
    	)?true:false;
