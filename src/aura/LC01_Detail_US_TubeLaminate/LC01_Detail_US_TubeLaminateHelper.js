	...
	setPrices : function(cmp, attr, attrName, _response){
    	...
    	for(var i = 0 ; i < _sectionLen ; i++){
    		...
    		if(_response[attrName] && _response[attrName][_title]){
    			//console.log('response[attrName][_title][0] : ' + _response[attrName][_title][0]);
    			//console.log('response[attrName][_title][0] : ' + _response[attrName][_title][0].List_Price__c);
        		...
        		_section[i].x30 = (_response[attrName][_title][4] ? _response[attrName][_title][4].List_Price__c : '');
        		_section[i].x50 = (_response[attrName][_title][5] ? _response[attrName][_title][5].List_Price__c : '');
        		_section[i].x100 = (_response[attrName][_title][6] ? _response[attrName][_title][6].List_Price__c : '');
        		_section[i].x250 = (_response[attrName][_title][7] ? _response[attrName][_title][7].List_Price__c : '');
        		_section[i].x500 = (_response[attrName][_title][8] ? _response[attrName][_title][8].List_Price__c : '');
               _section[i].xSpecific = (_response[attrName][_title][9] ? _response[attrName][_title][9].List_Price_Display__c : '');
        		...
        		_section[i].x30Override = (_response[attrName][_title][4] ? _response[attrName][_title][4].Price_Override__c : '');
        		_section[i].x50Override = (_response[attrName][_title][5] ? _response[attrName][_title][5].Price_Override__c : '');
        		_section[i].x100Override = (_response[attrName][_title][6] ? _response[attrName][_title][6].Price_Override__c : '');
        		_section[i].x250Override = (_response[attrName][_title][7] ? _response[attrName][_title][7].Price_Override__c : '');
        		_section[i].x500Override = (_response[attrName][_title][8] ? _response[attrName][_title][8].Price_Override__c : '');
        		_section[i].xSpecificOverride = (_response[attrName][_title][9] ? _response[attrName][_title][9].Price_Override__c : '');
        		console.log('Result xSpecific : ' + _section[i].xSpecific);
		    }
