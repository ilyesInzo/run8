({
    init: function(cmp, event, helper) {
        ...
        helper.convertList(cmp, "v.upperpartDeco");
        helper.convertList(cmp, "v.bottleUpcharge");
        helper.convertList(cmp, "v.pumpOptions");
    ...
    upperPartDecorationpricedescprice :  function(cmp, event, helper) {
        console.log('Pump Decoration override click');
    	cmp.set("v.upper_part_Decoration_desc_price","");
    	
    },
    
    bottleUpchargedescprice :  function(cmp, event, helper) {
    	cmp.set("v.bottle_upcharge_desc_price","");
    ...
    savedescprice :  function(cmp, event, helper) {
    	...
    	updatelistitems = helper.savepricehelper(cmp, "Upper Part Decoration", cmp.get("v.upperpartDeco"), updatelistitems);            
    	updatelistitems = helper.savepricehelper(cmp, "Bottle Upcharges", cmp.get("v.bottleUpcharge"), updatelistitems);
        updatelistitems = helper.savepricehelper(cmp, "Pump Options", cmp.get("v.pumpOptions"), updatelistitems);    
