({
 ...
 //**ticket 6329 */
	/*labellingadjust : function(cmp, event, helper) {
    	cmp.set("v.labelling_adjPrice","");
	},*/
    savedescprice :  function(cmp, event, helper) {
       ...
       //ticket 6329
		if(cmp.get("v.hideLine"))
		     {
		         updatelistitems = helper.savepricehelper(cmp, "Others", cmp.get("v.others"), updatelistitems);
		         updatelistitems = helper.savepricehelper(cmp, "Printing", cmp.get("v.printing"), updatelistitems);
		     }
		//Please Add Labeling adj
		//updatelistitems = helper.savepricehelper(cmp, "Printing", cmp.get("v.printing"), updatelistitems);
		//end ****
