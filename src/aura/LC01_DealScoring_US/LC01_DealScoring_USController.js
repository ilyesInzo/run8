({    
    ...
    resetscore: function(cmp, evt) {
		...
		//qli.Quote.Est_purchase_order_contract_duration__c = "";
		//qli.Quote.of_month_of_stock_at_Alb_a_expenses__c = "";
		//qli.Quote.Number_of_suppliers_for_customers__c = "";
		//qli.Quote.Indexation_of_raw_material_costs__c = "";
		//qli.Quote.Non_stock_customer_requirements__c = "";
		...
		//US Only
		qli.DS_Est_purchase_order_contract_duration__c = "";
		qli.DS_Number_of_suppliers_for_customers__c = "";
		qli.DS_Non_stock_customer_requirements__c = "";
