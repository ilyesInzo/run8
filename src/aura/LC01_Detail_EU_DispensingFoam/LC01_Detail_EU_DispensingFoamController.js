({
    init: function(cmp, event, helper) {
        ...
        helper.convertList(cmp, "v.pumpBottleDeco");
        helper.convertList(cmp, "v.printingUpcharge");
    ...
    savedescprice :  function(cmp, event, helper) {
    	...
    	updatelistitems = helper.savepricehelper(cmp, "Pump Bottle Decoration", cmp.get("v.pumpBottleDeco"), updatelistitems); 
    	updatelistitems = helper.savepricehelper(cmp, "Printing Upcharge", cmp.get("v.printingUpcharge"), updatelistitems);  	 
