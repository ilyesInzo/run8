({
	...
	getPrices : function(cmp, event){
        console.log('QLIID='+cmp.get("v.qli").Id);
        ...
        action.setCallback(this, function(response) {
        	...
        	this.setPrices(cmp, "v.pumpBottleDeco", 'Pump Bottle Decoration', _response.details);
        	this.setPrices(cmp, "v.printingUpcharge", 'Printing Upcharge', _response.details);
            ...
            cmp.set("v.currency", _response.currency);  
 			...
 			this.descprice(cmp, "v.pumpBottleDeco", "v.pump_Decoration_desc_price");    
 			this.descprice(cmp, "v.printingUpcharge", "v.printing_desc_price");     			
